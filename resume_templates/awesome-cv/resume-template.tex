...
\name{}{LINKEDIN_NAME}
\position{LINKEDIN_TITLE}
\address{LINKEDIN_LOCATION}

\mobile{LINKEDIN_MOBILE_NUMBER}
\email{LINKEDIN_EMAIL}
%\homepage{www.posquit0.com}
\github{LAST_SLASH(LINKEDIN_GITHUB)}
...
% Leave any of these blank if they are not needed
    ...
    \begin{cventries}
        ...
        {} % Location
        {LINKEDIN-SCHOOL-START-DATE - LINKEDIN-SCHOOL-END-DATE} % Date(s)
        {
